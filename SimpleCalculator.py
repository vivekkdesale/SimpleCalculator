...
e = Entry(root, width=22, borderwidth=5, font=('Dubai',20,'normal'))
...
button_0 = Button(root, text="0", padx=139, pady=20,command = lambda : button_click(0))
button_add = Button(root, text="+", padx=40, pady=52,command = button_add)
